...
if git_ok:
    ...
    if is_git_repo:
        ...
        if GIT_TOKEN != "REDACTED_GH_TOKEN":
...
if os.path.exists(CONFIG_PATH):
    try:
        ...
        if key and "COLLER_ICI" not in key and key.startswith("sk-"):
            ...
            if API_KEY != "REDACTED_ANTHROPIC_KEY":
    ...
    if API_KEY != "REDACTED_ANTHROPIC_KEY":
        ...
        print("    Remplacez COLLER_ICI_VOTRE_CLE_ANTHROPIC par votre cle.")
