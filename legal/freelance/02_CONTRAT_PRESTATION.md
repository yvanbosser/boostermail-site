...
> [NOTE INTERNE : ce contrat encadre la relation freelance principale. Il intègre les clauses critiques de propriété intellectuelle (article 9) et fait référence à l'accord de confidentialité (NDA) signé séparément.]
...
1.1 Le présent contrat (ci-après le « **Contrat** ») a pour objet de définir les conditions dans lesquelles le Prestataire fournit à PDLConsulting, à titre indépendant, des prestations de développement logiciel et services associés relatifs à BoosterMail (ci-après les « **Prestations** »).

1.2 La nature précise, le périmètre, les livrables, le calendrier et la rémunération de chaque mission spécifique sont définis dans une **Annexe Mission** signée par les Parties (cf. modèle joint), laquelle fait partie intégrante du présent Contrat.

1.3 Sauf stipulation contraire dans une Annexe Mission, les Prestations comprennent typiquement :

  a) L'analyse de spécifications fonctionnelles et techniques ;
  b) Le développement de fonctionnalités nouvelles ou la modification de fonctionnalités existantes (front-end, back-end, intégrations) ;
  c) La correction d'anomalies (bugs) ;
  d) La rédaction et l'exécution de tests ;
  e) La rédaction de documentation technique ;
  f) La participation aux revues de code (code reviews) ;
  g) La restitution des travaux et le transfert de connaissances.

---

## Article 2 — Indépendance des Parties

2.1 Le Prestataire intervient en qualité de prestataire **indépendant**. Il ne saurait en aucun cas être considéré comme salarié, mandataire social, agent commercial ou représentant de PDLConsulting.

2.2 Le Prestataire :

  a) Conserve la pleine maîtrise de l'organisation de son temps de travail, de ses méthodes et de ses outils, sous réserve du respect des spécifications et des délais convenus dans chaque Annexe Mission ;
  b) Fournit son propre matériel et ses propres logiciels nécessaires à l'exécution des Prestations, sauf accord contraire mentionné dans l'Annexe Mission ;
  c) N'est soumis à aucun horaire de travail imposé, à aucun lieu de travail imposé (hors réunions ponctuelles), ni à aucune obligation d'exclusivité ;
  d) Reste libre d'exercer toute autre activité professionnelle, sous réserve du respect de l'article 11 (non-concurrence) ;
  e) Assume seul la responsabilité de ses obligations sociales, fiscales et déclaratives auprès des administrations compétentes.

2.3 Le Prestataire garantit qu'il dispose de l'ensemble des autorisations, immatriculations et assurances nécessaires à l'exercice de son activité. Il s'engage à fournir à PDLConsulting, à première demande :

  a) Tout justificatif d'immatriculation à jour ;
  b) Une attestation de vigilance URSSAF (ou équivalent étranger) renouvelée au moins tous les **six (6) mois** ;
  c) Une attestation d'assurance Responsabilité Civile Professionnelle en cours de validité.

2.4 Le Prestataire s'oblige à informer sans délai PDLConsulting de toute modification affectant son immatriculation, sa situation juridique ou ses assurances, susceptible d'avoir une incidence sur l'exécution du Contrat.

---

## Article 3 — Durée

3.1 Le présent Contrat prend effet à compter de sa signature par la dernière des Parties.

3.2 [OPTION A — durée indéterminée, recommandée pour collaboration récurrente] Il est conclu pour une durée **indéterminée**. Chaque Partie peut le résilier à tout moment dans les conditions prévues à l'article 13.

3.2 [OPTION B — durée déterminée, pour mission unique bornée] Il est conclu pour une durée déterminée de [X mois / jusqu'au [date]] et prendra fin de plein droit à cette date, sauf renouvellement express et écrit des Parties.

3.3 La signature du présent Contrat ne crée aucune obligation pour PDLConsulting de confier des missions au Prestataire ; chaque mission donne lieu à la signature d'une Annexe Mission distincte. Le Prestataire ne peut prétendre à aucune indemnité du fait de l'absence ou de la diminution des missions confiées.

---

## Article 4 — Modalités d'exécution des Prestations

4.1 **Spécifications.** Le Prestataire exécute les Prestations conformément aux spécifications convenues dans l'Annexe Mission applicable, dans le respect des règles de l'art en matière de développement logiciel.

4.2 **Lieu d'exécution.** Sauf disposition contraire dans l'Annexe Mission, les Prestations sont exécutées **à distance**, depuis les locaux du Prestataire ou tout autre lieu de son choix garantissant la sécurité et la confidentialité (à l'exclusion notamment des espaces publics ouverts et des réseaux Wi-Fi non sécurisés).

4.3 **Outils et environnement.** Le Prestataire utilise les outils, dépôts de code, environnements et accès mis à sa disposition par PDLConsulting conformément à la **Charte de sécurité informatique** annexée au présent Contrat (Annexe 4). Il s'interdit d'utiliser des outils ou services tiers non autorisés pour le traitement des Informations Confidentielles ou des données personnelles.

4.4 **Disponibilité.** Le Prestataire s'engage à se rendre disponible, dans des plages horaires raisonnables (typiquement 9h-18h CET, jours ouvrés), pour les échanges, réunions de suivi et revues de code nécessaires à la bonne exécution des Prestations.
...
5.1 Le Prestataire s'engage à :

  a) Exécuter les Prestations avec diligence, professionnalisme et conformément aux règles de l'art ;
  b) Respecter les délais convenus dans chaque Annexe Mission, et alerter sans délai PDLConsulting de tout risque de retard ou d'écart par rapport aux spécifications ;
  c) Tenir PDLConsulting informée régulièrement (a minima de manière hebdomadaire, sauf accord contraire) de l'avancement des Prestations ;
  d) Respecter les standards de qualité, de sécurité et les conventions de codage en vigueur chez PDLConsulting (cf. fichier `CLAUDE.md` du dépôt et documentation associée) ;
  e) Tester son code avant livraison et garantir un niveau de qualité compatible avec une mise en production ;
...
## Article 6 — Obligations de PDLConsulting

6.1 PDLConsulting s'engage à :

  a) Fournir au Prestataire les informations, accès, documentations et ressources nécessaires à l'exécution des Prestations dans des délais raisonnables ;
  b) Désigner un interlocuteur unique en charge du suivi de la collaboration ;
  c) Procéder à la recette des livrables dans les délais convenus dans chaque Annexe Mission ;
  d) Régler les factures du Prestataire dans les conditions prévues à l'article 8.

---

## Article 7 — Recette des livrables

7.1 Chaque livrable mentionné dans une Annexe Mission fait l'objet d'une procédure de recette par PDLConsulting.

7.2 PDLConsulting dispose d'un délai de **dix (10) jours ouvrés** à compter de la livraison effective pour vérifier la conformité du livrable aux spécifications convenues.

7.3 Au terme de ce délai :

  a) Soit PDLConsulting prononce la **recette** du livrable, expressément ou tacitement (à défaut de réserves notifiées dans le délai) ;
  b) Soit PDLConsulting notifie au Prestataire des **réserves** dûment motivées, lequel dispose alors d'un délai de **dix (10) jours ouvrés** pour effectuer les corrections nécessaires sans facturation supplémentaire ;
  c) Le cycle de recette peut être réitéré une fois ; en cas de persistance des non-conformités après le second cycle, PDLConsulting peut, à son choix : (i) faire exécuter les corrections par un tiers aux frais du Prestataire, (ii) résilier le Contrat dans les conditions de l'article 13, ou (iii) accepter le livrable avec une réfaction de prix proportionnée.

7.4 Les bugs mineurs n'empêchant pas l'usage normal du livrable n'ouvrent pas droit à un refus de recette mais font l'objet d'une correction dans les conditions du suivi opérationnel.
...
9.1 **Définition.** Sont qualifiées d'« **Œuvres** », au sens du présent article, l'ensemble des créations intellectuelles, originales ou non, réalisées par le Prestataire dans le cadre ou à l'occasion des Prestations, notamment :
  ...
  a) Les codes sources, codes objets, scripts, configurations, schémas de bases de données ;
  b) Les algorithmes, méthodes, modèles de prompts, paramétrages d'IA ;
  c) Les documents de spécifications, rapports techniques, documentations utilisateur ;
  d) Les éléments graphiques (interfaces, icônes, maquettes, logos) ;
...
9.2 **Cession exclusive et définitive — Effet à la création.** Le Prestataire **cède à PDLConsulting**, **à titre exclusif et définitif**, **au fur et à mesure de la création des Œuvres** et de manière automatique, sans formalité supplémentaire, l'ensemble des droits de propriété intellectuelle attachés aux Œuvres, et ce :
  ...
  b) **Tous supports** : tout support et tout format actuel ou futur, connu ou inconnu à ce jour, notamment numérique, électronique, optique, papier, et sur tous réseaux de communication électronique ;

  c) **Toutes destinations** : toutes destinations, à titre gratuit ou onéreux, notamment commerciale, publicitaire, promotionnelle, à l'exclusion d'aucune ;
...
9.4 **Composants tiers.** Le Prestataire s'interdit d'incorporer dans les Œuvres des composants tiers (notamment des bibliothèques open source) dont la licence imposerait à PDLConsulting des obligations contraires à ses intérêts (en particulier les licences dites « copyleft » de type GPL, AGPL, qui imposeraient à PDLConsulting de divulguer son code source). Le Prestataire utilise uniquement des composants sous licences permissives (MIT, BSD, Apache 2.0) ou compatibles avec une exploitation commerciale propriétaire. En cas de doute, l'accord écrit préalable de PDLConsulting est requis.

9.5 **Garantie d'éviction.** Le Prestataire garantit PDLConsulting contre toute action en revendication de droits de propriété intellectuelle qui serait formée par des tiers à l'encontre des Œuvres. À ce titre, le Prestataire :

  a) Garantit l'originalité des Œuvres et déclare qu'elles ne portent pas atteinte aux droits de tiers ;
  b) S'engage à indemniser PDLConsulting de toutes condamnations, frais et honoraires (notamment d'avocat) qu'elle aurait à supporter du fait d'une telle action ;
  c) S'engage à intervenir à toute procédure et à fournir toute assistance nécessaire à la défense de PDLConsulting.

9.6 **Droits moraux.** Conformément à l'article L. 121-1 du Code de la propriété intellectuelle, le Prestataire conserve ses droits moraux. Toutefois, dans la mesure permise par la loi, le Prestataire :

  a) Renonce à exiger la mention de son nom sur les Œuvres et leurs exploitations ;
  b) Autorise PDLConsulting à modifier librement les Œuvres, à les adapter, les corriger, les compléter, à condition que ces modifications ne portent pas atteinte à son honneur ou à sa réputation.

9.7 **Travaux antérieurs et personnels.** Les travaux que le Prestataire réalise en dehors et indépendamment des Prestations demeurent sa pleine propriété. Toutefois, en cas de chevauchement entre des travaux personnels et les Prestations, la cession prévue au présent article s'applique à toute fraction des travaux intégrée dans les Œuvres ou utilisée pour leur création.

---

## Article 10 — Confidentialité

10.1 Les obligations de confidentialité du Prestataire sont régies par l'**Accord de Confidentialité Bilatéral** signé entre les Parties préalablement au présent Contrat, dont les termes demeurent intégralement applicables et complètent le présent Contrat.

10.2 Sans préjudice des obligations résultant dudit Accord, le Prestataire reconnaît expressément que :

  a) L'ensemble des accès, identifiants, mots de passe et secrets cryptographiques mis à sa disposition par PDLConsulting sont strictement personnels et ne peuvent être partagés ;
  b) Le Prestataire est tenu de respecter la **Charte de sécurité informatique** (Annexe 4) qui détaille les règles techniques applicables.
...
13.1 **Résiliation pour convenance.** Chaque Partie peut résilier le présent Contrat, à tout moment et sans avoir à justifier d'un motif, moyennant le respect d'un préavis de **trente (30) jours calendaires** notifié par lettre recommandée avec accusé de réception ou par voie électronique avec accusé de réception.

13.2 **Résiliation pour faute.** En cas de manquement grave par l'une des Parties à l'une de ses obligations contractuelles, l'autre Partie peut résilier le Contrat de plein droit, après mise en demeure restée infructueuse pendant un délai de **quinze (15) jours**, par lettre recommandée avec accusé de réception, sans préjudice de toute action en réparation du préjudice subi.

13.3 **Résiliation immédiate.** Le Contrat peut être résilié immédiatement et de plein droit par PDLConsulting, sans préavis ni indemnité, en cas :

  a) De manquement du Prestataire à ses obligations de confidentialité (article 10) ou de propriété intellectuelle (article 9) ;
  b) De manquement grave du Prestataire à la Charte de sécurité informatique (Annexe 4) susceptible d'exposer PDLConsulting à un risque de sécurité ou de conformité ;
  c) De fausse déclaration du Prestataire concernant son immatriculation, ses assurances ou son indépendance ;
  d) D'ouverture d'une procédure de redressement, de liquidation judiciaire ou équivalente affectant le Prestataire.

13.4 **Conséquences de la résiliation.** En cas de résiliation, quelle qu'en soit la cause :
...
14.1 Dans le cadre de l'exécution du Contrat, chacune des Parties peut être amenée à traiter des données personnelles concernant l'autre Partie ou ses représentants. Chaque Partie s'engage à respecter la réglementation applicable en matière de protection des données personnelles, notamment le Règlement (UE) 2016/679 (« RGPD »).

14.2 Si l'exécution des Prestations conduit le Prestataire à accéder, traiter ou héberger des données personnelles d'utilisateurs de la solution BoosterMail (par exemple : accès à la base de données de production, lecture de logs contenant des emails utilisateurs), le Prestataire intervient en qualité de **sous-traitant ultérieur** au sens de l'article 28 du RGPD. Dans ce cas, les Parties signeront un **Accord de Sous-Traitance des Données Personnelles** (DPA) distinct, qui prévaudra sur les présentes en cas de contradiction.

14.3 À défaut de signature d'un tel DPA, **le Prestataire s'interdit tout accès, traitement ou copie de données personnelles d'utilisateurs**, et utilise exclusivement des jeux de données factices ou anonymisés à des fins de développement et de test.
...
16.1 **Annexes.** Sont annexées au présent Contrat et en font partie intégrante :

  - **Annexe 1** : Annexe Mission (à signer pour chaque mission spécifique) ;
  - **Annexe 2** : Accord de Confidentialité Bilatéral (signé séparément, repris par référence) ;
  - **Annexe 3** : [supprimer si non applicable] Accord de Sous-Traitance des Données Personnelles (DPA) ;
  - **Annexe 4** : Charte de sécurité informatique.

16.2 **Intégralité de l'accord.** Le Contrat, ses Annexes et le NDA constituent l'intégralité de l'accord entre les Parties relativement à son objet et se substituent à tous accords antérieurs, écrits ou oraux.

16.3 **Modifications.** Toute modification du Contrat requiert un avenant écrit signé par les deux Parties. Aucune modification verbale ou implicite ne peut être opposée à PDLConsulting.

16.4 **Indépendance des clauses.** La nullité, l'illégalité ou l'inapplicabilité de l'une quelconque des stipulations du Contrat n'affecte pas la validité, la légalité ou l'applicabilité des autres stipulations.
...
> [NOTE INTERNE : faire parapher chaque page par les deux parties + faire signer chaque annexe séparément.]
