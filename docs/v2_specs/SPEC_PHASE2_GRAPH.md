...
> ⚠️ **DOCUMENT PARTIELLEMENT PÉRIMÉ** (12/04/2026)
> Mention de `V1_outlook/` (renommé `V2/` en 14-18/04) et de « Mode Standard » (renommé « Mode Complet » le 10/04).
> Les APIs Graph décrites restent valables.
