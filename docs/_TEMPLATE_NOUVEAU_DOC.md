...
> **Statut** : 🟢 À jour | 🟡 Partiel | 🔴 Obsolète (voir `docs/xxx.md`)
> **Auteur** : Claude + Yvan
> **Sujet** : [1 ligne résumé]

---

## Résumé (1-2 phrases)

Pourquoi ce document existe et ce qu'il couvre.
...
| Besoin | Doc |
|---|---|
| [Exemple : Spec du moteur IA] | [`docs/specs_proto/SPEC_SYSTEM_PROMPT.md`](specs_proto/SPEC_SYSTEM_PROMPT.md) |
