...
> **Dernière mise à jour** : 21/05/2026 — cadrage **classement PJ V12** livré sur `feat/yvan/frontend` :
...
| **Classement PJ V12 — `attachment_folder_history` + popup `smart_paperclip` rallumée + symétrie moteur** (cadré 21/05) ⭐ | `docs/architecture/V12/v12 _ classement PJ.md` |
